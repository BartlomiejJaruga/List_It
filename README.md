# <img src="aplikacja_administratora/src/assets/list_it_icon.png" width="25" height="25"> ListIt
...
2. Ekran logowania/rejestracji: <br><br>
     <img src="screenshots/ekran_uzytkownika_logowanie.PNG" height="500"> <img src="screenshots/ekran_uzytkownika_rejestracja.PNG" height="500"><br><br>
3. Przechodzenie między kolejnymi częściami aplikacji dzięki rozwijanemu menu w lewym górnym rogu ekranu: <br><br>
     <img src="screenshots/ekran_uzytkownika_rozwijane_menu.PNG" height="500"><br><br>
4. Przegladanie, komentowanie i polubianie wydarzeń: <br><br>
    <img src="screenshots/ekran_uzytkownika_wydarzenia.PNG" height="500">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="screenshots/ekran_uzytkownika_wydarzenia_glaskanie_kotow.PNG" height="500">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="screenshots/ekran_uzytkownika_wydarzenia_glaskanie_kotow_komentarze.PNG" height="500"><br><br>
5. Prywatna lista zadań do wykonania (to-do list), możliwość dodawania, usuwania i odznaczania wykonanych zadań: <br><br>
     <img src="screenshots/ekran_uzytkownika_to_do_list.PNG" height="500">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="screenshots/ekran_uzytkownika_to_do_list_wykonane_zadania.PNG" height="500"><br><br>
     Dodawanie nowego zadania (klikamy przycisk `+` w prawym górnym rogu): <br><br>
     <img src="screenshots/ekran_uzytkownika_to_do_list_nowe_zadanie.PNG" height="500"><br><br>
     ...
     <img src="screenshots/ekran_uzytkownika_to_do_list_usuwanie_zadan1.PNG" height="500"><br><br>
6. Zakładka ustawienia i możliwość zarządzania swoją platformą: <br><br>
    <img src="screenshots/ekran_uzytkownika_ustawienia.PNG" height="500"><br><br>
    Tryb ciemny całej platformy:<br><br>
   <img src="screenshots/ekran_uzytkownika_ustawienia_tryb_ciemny.PNG" height="500">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="screenshots/ekran_uzytkownika_wydarzenia_tryb_ciemny.PNG" height="500">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img                          src="screenshots/ekran_uzytkownika_to_do_list_tryb_ciemny.PNG" height="500"><br><br>
    Zmiana hasła do konta:<br><br>
    <img src="screenshots/ekran_uzytkownika_ustawienia_zmiana_hasla.PNG" height="500"><br><br>
    Powiadomienie potwierdzające zmianę hasła:<br><br>
    <img src="screenshots/ekran_uzytkownika_ustawienia_zmiana_hasla_powiadomienie.PNG" height="100"><br><br>
    Możliwość wylogowania się wraz z potwierdzeniem:<br><br>
    <img src="screenshots/ekran_uzytkownika_ustawienia_potwierdzenie_wylogowania.PNG" height="500"><br><br>
7. Możliwość zgłaszania błędów występujących w aplikacji:<br><br>
    <img src="screenshots/ekran_uzytkownika_zglos_blad.PNG" height="500"><br><br>
